...
const InterfaceSelector = ({ socket, isConnected, onStartCapture }) => {
      ...
      <div className="nta-card-body">
        ...
        {loading ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-slate-400">Loading network interfaces...</p>
          </div>
        ) : (
          <>
            <div className="mb-8">
                  ...
                  <div className="p-4">
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-lg font-semibold text-slate-100">{interfaces.length}</p>
                      </div>
                    </div>
                  </div>
                </div>
